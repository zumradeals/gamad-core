#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Contrôle actif du corpus pendant la transition hors Genesis II.

Le contrôleur historique reste inchangé dans `outils/verifier-integrite.py` afin
que son empreinte adoptée demeure vérifiable. Ce point d'entrée réutilise tous
ses contrôles et remplace uniquement C5 pour les fichiers de conduite
opérationnelle qui doivent pouvoir évoluer avec le dépôt.
"""
