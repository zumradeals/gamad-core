...
- `apps/console-laravel/app/Http/Controllers/Api/V1/MatchingController.php` — 20 routes sous `/api/v1/matching/*` (contextes, profils, demandes, résultats, segments, activations/mesures, contestations).
