...
final class PostgreSqlUserAccountRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        (new PostgreSqlPersonRepository($this->connection))->save(Person::register(new PersonId('GAM-PER-900001'), 'Amina Traoré'));
    }
    ...
    public function test_it_saves_and_finds_an_account_with_its_authentication_methods(): void
    {
        ...
        $found = $repository->findByPersonId(new PersonId('GAM-PER-900001'));
        ...
        self::assertTrue($repository->existsForPerson(new PersonId('GAM-PER-900001')));
    }

    public function test_it_enforces_at_most_one_account_per_person_at_the_database_level(): void
    {
        $repository = new PostgreSqlUserAccountRepository($this->connection);
        $repository->save(UserAccount::create(UserAccountId::generate(), new PersonId('GAM-PER-900001')));
