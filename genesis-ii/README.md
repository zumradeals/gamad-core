...
Avant `G0`, devront encore être adoptés ou réalisés le Lexique canonique initial, les premières Lois et invariants du Core, l’Atlas initial, le Registre initial des capacités souveraines et les autres registres, modèles et contrôles exigés.
...
10. `CORE-CHARTER-0001`
11. `PRODUCT-CONSTITUTION-0001`
12. les statuts canoniques et registres d’adoption correspondants
13. les futurs textes organiques et techniques dans l’ordre prévu par la Constitution de gouvernance
