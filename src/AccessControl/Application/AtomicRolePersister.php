...
final readonly class AtomicRolePersister
{
    ...
    {
        $events = $this->events->collect($role);

        $this->transactions->transactional(function () use ($role, $events): void {
